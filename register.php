...
<div class="wrap"> 
	<div class="header-bot">
		 <div class="logo">
			 <a href="index.html"><img src="images/showroomcover.png" alt="" style="width:450px; height: 160px;"></a>
		 </div>
...
<?php 
$db=mysqli_connect("localhost","root","Syedafnan78647","car_showroom");
...
if(isset($_POST['reg'])) 
{
    ...
    if($useremail!='' || $username!=''|| $password!=''|| $userphone!=''|| $useraddress!='' )
    {
       //$query = "CALL register('$username','$useremail','$password','$userphone','$useraddress')";
        ...
        $query= "insert into customer(name,email,pass,phone,address) values ('$username' , '$useremail', '$pass', '$userphone', '$useraddress')";
